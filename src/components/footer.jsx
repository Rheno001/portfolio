...
function footer() {
  return (
    <div className='footerbg pt-[50px] pb-[30px] px-4 sm:px-6 lg:px-8'>
        ...
        <div className='flex items-center justify-start mt-[20px]'><img src={rightarrow} alt="Right pointing arrow" className='w-[25px] md:w-[30px]' /><h2 className='text-[20px] md:text-[40px] text-[#fff] ml-[10px] md:ml-[20px]'>renfredreuben@gmail.com</h2></div>
        <div className='flex items-center justify-end mt-[15px]'>
            <img src={git} 
                alt="Github Logo"
                className='mx-[10px] h-[35px] md:h-[52px] hover:scale-120 transition-all' />
            <img src={twit} 
                alt="X Logo"
                className='mx-[10px] h-[35px] md:h-[52px] hover:scale-120 transition-all' />
        </div>

    ...
    <div className={`pb-[20px] md:pb-[100px] pt-[100px] transform transition-all duration-1000 ease-out ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
      ...
      <div className='flex flex-col items-center justify-center mt-[25px] md:mt-[60px] relative px-4 sm:px-6 lg:px-31'>
        ...
        <div className="mobile w-full">
          <h1 className='block md:hidden w-full integral-font text-[#54625A] text-[35vw] font-black relative leading-25 mx-auto'>RENF <br />RED -</h1>
          <h1 className='block md:hidden w-full integral-font text-[#54625A] text-[42vw] font-black relative leading-30 ml-[-3px] mx-auto'>REU <br />BEN</h1>
        </div>
        <img 
          src={oldLaptop} 
          alt="Old Computer" 

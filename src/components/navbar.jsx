...
function Navbar() {
  ...
  return (
    <>
      <nav
        className={`fixed top-0 left-0 w-full flex-1 items-center justify-center z-50 h-[73px] pb-[85px] transition-colors duration-300 ${
          isScrolled ? "bg-[#fff]/90" : "bg-none"
        }`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <button className="hidden md:block bg-[#EDFFFA] border-4 rounded-[18px] py-[12px] px-[3px] border-[#54625A]">
              <a
                href="https://silver-mair-61.tiiny.site/"

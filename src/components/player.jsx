...
function Player() {
  ...
  return (
    <>
      ...
      >
        <img src={song1Img} alt="Play Song 1" onClick={() => toggleAudio('song1')} className="w-[150px] md:w-[223px] hover:scale-110 transition-all cursor-pointer" />
        <img src={song2Img} alt="Play Song 2" onClick={() => toggleAudio('song2')} className="w-[150px] md:w-[223px] hover:scale-110 transition-all cursor-pointer" />
        <img src={song3Img} alt="Play Song 3" onClick={() => toggleAudio('song3')} className="w-[150px] md:w-[223px] hover:scale-110 transition-all cursor-pointer" />
        <img src={song4Img} alt="Play Song 4" onClick={() => toggleAudio('song4')} className="w-[150px] md:w-[223px] hover:scale-110 transition-all cursor-pointer" />
        <img src={song5Img} alt="Play Song 5" onClick={() => toggleAudio('song5')} className="w-[150px] md:w-[223px] hover:scale-110 transition-all cursor-pointer" />
